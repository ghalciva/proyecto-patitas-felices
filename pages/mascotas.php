...
<html class="no-js">
  <head>
    ...
    <title> Mascotas - Patitas felices</title>
              ...
              <div class="col-md-12">
                <div class="block">
                    <table>
                        ...
                        <tr>
                            <td class="sidebartitle"> Perros </td>
                        </tr>
                        <tr>
                            <td> 
                                <ul> <li> &nbsp; </li>
                                    <li> <a href="perros.php" class="sidebarsubt">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Galeria de perros </a> </li>
                                </ul> 
                            </td>
                        </tr>
                        <tr>
                            <td class="sidebartitle"> Gatos  </td>
                        </tr>
                        <tr>
                            <td> 
                                <ul> <li> &nbsp; </li>
                                    <li> <a href="gatos.php" class="sidebarsubt">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Galeria de gatos </a> </li>
                                </ul> 
                            </td>
                        </tr>
                    </table>
