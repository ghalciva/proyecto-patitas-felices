    ...
    <section id="slider">
        <section id="contact-form">
          <div class="container"><center>
              <div class="col-md-12">
                    <div class="block">
                    <form action="saveUpdatePerro.php" method="get">
                        <h1 class="form-group">M O D I F I C A R &nbsp;&nbsp;&nbsp; P E R R O </h1>
			<?php
				echo "<label>IdPerro</label>";
				echo "<div class='form-group'>";
				echo "<input type='text' name='idPerro' class='form-control' value='". $idPerro . "' readonly>";
				echo "</div>";
				...
				echo "</div>";
				echo "<a href='saveUpdatePerro.php?idPerro=". $idPerro ."'><button class='btn btn-default' type='submit'> Siguiente </button>";
