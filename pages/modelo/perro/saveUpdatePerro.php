...
$perroCollectorObj = new perroCollector();
				...
				echo "<p>Se han modificado los cambios en la tabla Perro!</p>";
			        $perroCollectorObj->updateDog($idPerro,$idMascota,$nombre,$edad,$sexo,$raza);
				$perroCollectorObj->saveDog($idPerro);
		        	echo "<meta HTTP-EQUIV='REFRESH' CONTENT='1;URL=readPerro.php'>";
                            	}else{   
