      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10 col-md-offset-2">
            <div class="block">
                 <h1>Tabla Animal</h1>
    <a href="createAnimal.php"><button class="btn btn-default btn-call-to-action">Crear Animal</button></a> <br>
    <table id="tabla">
        <tr>    
            <th>&nbsp;&nbsp;IdMascota&nbsp;&nbsp;</th>
            <th>&nbsp;&nbsp;Nombre&nbsp;&nbsp;</th>
        ...
        <?php
            ...
            echo "<td><a href='updateAnimal.php?idMascota=" . $c->getidMascota() . "&nombre=" . $c->getNombre() . "&fecha=" . $c->getFecha() . "&edad=" . $c->getEdad() . "&sexo=" . $c->getSexo() . "&raza=" . $c->getRaza() . "&imagen=" . $c->getImagen() . "&color=" . $c->getColor()."'> <button class='btn btn-default btn-call-to-action'>Editar</button></a></td>";
            echo "<td><a href='deleteAnimal.php?idMascota=". $c->getidMascota() ."'><button class='btn btn-default btn-call-to-action'>Eliminar</button></a></td>";
            echo "</tr>"; 
