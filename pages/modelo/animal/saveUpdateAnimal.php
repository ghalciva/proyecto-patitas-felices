...
$animalCollectorObj = new animalCollector();
				...
				echo "<p>Se han modificado los cambios en la tabla Animal!</p>";
			        $animalCollectorObj->updateAnimal($idMascota,$nombre,$raza,$edad,$fecha,$color,$sexo,$imagen);
				$animalCollectorObj->saveAnimal($idMascota);
