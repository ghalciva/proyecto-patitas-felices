      ...
      <div class="container">
        <div class="row">
          <div class="col-md-10 col-md-offset-2">
            <div class="block">
                 <h1>Tabla Gato</h1>
    <a href="createGato.php"><button class="btn btn-default btn-call-to-action">Crear Gato</button></a> <br>
    <table id="tabla">
        <tr>    
            <th>&nbsp;&nbsp;IdGato&nbsp;&nbsp;</th>
            <th>&nbsp;&nbsp;IdMascota&nbsp;&nbsp;</th>
        ...
        <?php
            foreach ($gatoCollectorObj->showCats() as $c){
            echo "<tr>";
            echo "<td>" . $c->getIdGato() . "</td>";
            ...
            echo "<td><a href='updateGato.php?idGato=" . $c->getidGato() . "&idMascota=" . $c->getIdMascota() . "&nombre=" . $c->getNombre() . "&edad=" . $c->getEdad() . "&sexo=" . $c->getSexo() . "&raza=" . $c->getRaza()."'> <button class='btn btn-default btn-call-to-action'>Editar</button></a></td>";
            echo "<td><a href='deleteGato.php?idGato=". $c->getidGato() ."'><button class='btn btn-default btn-call-to-action'>Eliminar</button></a></td>";
            echo "</tr>"; 
