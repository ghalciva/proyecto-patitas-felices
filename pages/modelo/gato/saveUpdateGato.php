...
$gatoCollectorObj = new gatoCollector();
				...
				echo "<p>Se han modificado los cambios en la tabla Gato!</p>";
			        $gatoCollectorObj->updateCat($idGato,$idMascota,$nombre,$edad,$sexo,$raza);
				$gatoCollectorObj->saveCat($idGato);
